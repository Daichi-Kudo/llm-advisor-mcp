...
| v0.4 | **Current** | Release-date filtering, freshness scoring, composite benchmark scoring, MCP tool annotations, smoke-test gates + 66 tests |
...
npm test            # Run 66 unit tests (vitest)
...
4. Run `npm test` to verify all 66 tests pass
